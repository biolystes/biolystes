...
- 🆕 **Anti-cernes correcteur, 30 Tan Neutral** (NOUVEAUTÉ — Maquillage) — 4 ml / 0.14 fl oz — 13,20 € / pièce — Acide hyaluronique, antioxydants végétaux, pigments minéraux naturels — Couvrance modulable d'aspect naturel, dissimule imperfections et cernes, fini lisse et lumineux sans marquer les ridules. Utilisable en correction localisée, éclaircissement global ou contouring (teintes foncées). Convient au contour des yeux des peaux sensibles. Disponible en 7 teintes : 05 Clair et frais, 10 Léger et chaud, 15 Pas mal, 20 Température moyenne, 25 Moyen Neutre, 30 Tan Neutre, 35 Neutre profond. 98% origine naturelle, 10% bio. Certifié COSMOS NATURAL ECOCERT, testé dermatologiquement, végan, sans gluten, sans noix, sans parfum, sans allergène étiquette.
