  ...
  return (
    <div className="min-h-screen bg-background -mx-6 lg:-mx-10 -mt-6 lg:-mt-10">
      ...
      <section className="max-w-5xl mx-auto px-6 py-24 md:py-32">
        <SectionLabel label="Le constat" title="Nous avons créé Biolystes car de nombreuses personnes échouent en raison de choix inadaptés lors du lancement de leur marque cosmétique bio et végane." />
