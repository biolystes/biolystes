            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
              ...
              <div className="relative rounded-2xl p-7 md:p-9 flex flex-col border-2 border-foreground">
                ...
                <div className="flex flex-col mb-8">
                  {["4 produits certifiés bio chez vous en 7 jours", "Création de votre logo", "Design packaging", "Shooting photo IA de vos produits", "Accompagnement personnalisé dans la sélection par nos experts", "Certifié Bio & Végan / COSMOS / ECOCERT / FDA", "Livraison incluse sous 7 à 8 jours"].map((t, i) => (
