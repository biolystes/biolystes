        ...
        <div className="max-w-4xl mx-auto text-center">
          <SectionBlock>
            ...
            <motion.h1 variants={fadeUp} custom={1}
              ...
              <span className="font-bold">92%</span> des porteurs de projets cosmétiques avec formulation sur mesure n'ont toujours pas lancé leur marque <span className="font-bold">7 mois après.</span>
            </motion.h1>
