...
/* ═══════════════════════════════════════════════════
   PHONE HEADER
   ═══════════════════════════════════════════════════ */
function PhoneHeader({ borderBottom }: { borderBottom?: boolean }) {
  return (
    <div className={`flex items-center justify-between px-5 pt-10 pb-4 z-20${borderBottom ? " shrink-0 border-b border-border" : ""}`}>
...
function AvecLystesPhone() {
  ...
  const ugcThumbs = [kaniwaUgc3, kaniwaUgc4, kaniwaUgc2, kaniwaUgc5, kaniwaUgc3, kaniwaUgc4, kaniwaUgc2, kaniwaUgc5];
        ...
        <section className="py-24 md:py-36">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="lg:hidden flex flex-wrap gap-2 justify-center mt-2">
              {[
                "Équipe Marketing AI",
                "Équipe Photographe AI",
                "Équipe Expert SEO AI",
                "Équipe Expert produit AI",
                "Équipe Diagnostics AI",
                "Équipe Créateur de contenu AI",
                "Équipe Analytics AI",
              ].map((label) => (
