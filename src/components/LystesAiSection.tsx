  ...
  return (
    <div className="text-center max-w-[1120px] mx-auto px-6 pt-24 pb-12">
      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={3}
        className="grid grid-cols-3 max-w-lg mx-auto pt-14 pb-6 divide-x divide-border">
        {[
          ...
          <div key={s.label} className="text-center px-8">
            ...
            <div className="text-[10px] text-muted-foreground font-semibold mt-3 uppercase tracking-[0.15em]">{s.label}</div>
          </div>
        ))}
      </motion.div>
    </div>
